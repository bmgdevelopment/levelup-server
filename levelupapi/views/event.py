...
class EventSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Event
        fields = ('id', 'game', 'gamer', 'organizer',
...
def signup(self, request, pk=None):
    ...
    # User wants to leave a previously joined event
        ...
        try:
            # The many to many relationship has a .remove method
            # that removes the gamer from the attendees list
            # The method deletes the row in the join table
            # that has the gamer_id and event_id
